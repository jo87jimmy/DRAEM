...
def test(obj_names, mvtec_path, checkpoint_path, base_model_name):
    ...
    for obj_name in obj_names:
        ...
        dataset = MVTecDRAEMTestDataset(mvtec_path + obj_name + "/test/",
    ...
    write_results_to_file(run_name, obj_auroc_image_list, obj_auroc_pixel_list,
                          obj_ap_image_list, obj_ap_pixel_list)
